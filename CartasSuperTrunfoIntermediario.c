...
int main(){
    ...
    //Variáveis de Carta1 e Carta2
      ...
      float resultado_percapita1;
      float resultado_percapita2; 
      float resultado_densidade1;
      float resultado_densidade2;
      int conversao = 1000000000;
    ...
    scanf("%d", &num_ponto_turistico2);
     ...
     //Cálculos Densidade Populacional - Carta1 e Carta2
    resultado_densidade1 = (populacao1 / area_km1);
    resultado_densidade2 = (populacao2 / area_km2);

    //Cálculo PIB Per Capita-Carta1 e Carta2
    resultado_percapita1 = (float) ((pib1 * conversao) / populacao1);
    resultado_percapita2 = (float) ((pib2 * conversao) / populacao2);
